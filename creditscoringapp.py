...
# ---------------------------
# STRICT CLEANING PIPELINE (FIXED)
# ---------------------------
def clean_numeric(df):
    df = df.copy()

    # remove brackets, quotes, weird strings
    ...
    # force float32 (important for XGBoost + SHAP)
...
# ---------------------------
# SHAP BUSINESS INTERPRETATION (FIXED)
# ---------------------------
